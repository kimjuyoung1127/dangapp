...
description: Upgrade /register route UI, data flow, and route-specific behavior for parity work. Use when implementing or stabilizing /register and its directly related feature modules and hooks.
---

# page-register-upgrade

## Trigger
- Improve or finish /register
- Resolve parity work for DANG-AUTH-002
- Stabilize the route before QA or Done

## Input Context
- Route: /register
- Page file: frontend/src/app/(auth)/register/page.tsx
- Parity: DANG-AUTH-002
- Priority: P1
...
## Acceptance Focus
- OTP gate, consent checks, onboarding redirect
