...
description: Upgrade /modes route UI, data flow, and route-specific behavior for parity work. Use when implementing or stabilizing /modes and its directly related feature modules and hooks.
---

# page-modes-upgrade

## Trigger
- Improve or finish /modes
- Resolve parity work for DANG-MODE-001
- Stabilize the route before QA or Done

## Input Context
- Route: /modes
- Page file: frontend/src/app/(main)/modes/page.tsx
- Parity: DANG-MODE-001
- Priority: P1
...
## Related Files
- frontend/src/app/(main)/modes/page.tsx
- frontend/src/stores/useModeStore.ts
...
## Acceptance Focus
- mode unlock state, progress display, unlock flow
