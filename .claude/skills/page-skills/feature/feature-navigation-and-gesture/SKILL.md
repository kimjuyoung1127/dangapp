...
description: Refine route transitions, back navigation, sheet flows, and touch interactions in DangApp. Use when a page needs navigation polish, gesture-safe modals/sheets, or interaction consistency across mobile-first flows.
---
...
6. Keep navigation behavior small and local unless the route flow truly changes.
