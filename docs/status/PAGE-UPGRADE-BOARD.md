...
| `/modes` | Modes | Main | P2 | Ready | claude | DANG-MAT-001, DANG-B2B-001 | `page-modes-upgrade` | `feature-navigation-and-gesture` | `docs/status/PROJECT-STATUS.md` | 2026-03-05 |
| `/care` | Care | Main | P2 | Ready | claude | DANG-B2B-001 | `page-care-upgrade` | `feature-data-binding-and-loading` | `docs/status/PROJECT-STATUS.md` | 2026-03-05 |
| `/family` | Family | Main | P2 | Ready | claude | DANG-B2B-001 | `page-family-upgrade` | `feature-data-binding-and-loading` | `docs/status/PROJECT-STATUS.md` | 2026-03-05 |
